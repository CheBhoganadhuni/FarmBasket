...
# Limit request body size (for image uploads)
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.getenv('DATABASE_URL', f"postgres://{os.getenv('DB_USER', 'farmuser')}:{os.getenv('DB_PASSWORD', 'farm_pass')}@{os.getenv('DB_HOST', 'localhost')}:{os.getenv('DB_PORT', '5432')}/{os.getenv('DB_NAME', 'farmbasket')}"),
        conn_max_age=600
    )
}
